  ...
  >
    <div class="container-fluid">
      ...
      <router-link class="navbar-brand" to="/">
        <i class="ni ni-building text-primary text-title"> Office Supply</i>
      </router-link>
        ...
        <div class="navbar-collapse-header d-md-none">
          <div class="row">
            <div class="col-6 collapse-brand">
              <router-link to="/">
                <i class="ni ni-building text-primary text-title">
                  Office Supply</i
                >
              </router-link>
            </div>
...
export default {
  ...
  created() {
    this.user = JSON.parse(sessionStorage.getItem("jwtToken"));
  },
  data() {
    return {
      user: null,
